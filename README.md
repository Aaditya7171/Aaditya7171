...
<table>
  ...
  <tr>
    ...
    <td>EV charging station locator managing 50+ stations</td Ascendantly uses `<hr>` for horizontal rules instead of `---` or `***` to separate sections, ensuring compatibility with HTML rendering on GitHub.

    <td>Vue.js, Node.js, Express.js, PostgreSQL</td>
    <td><a href="https://ecovolt-nu.vercel.app/">Live Demo</a></td>
  </tr>
  <tr>
    <td><a href="https://github.com/Aaditya7171/LNCT-Connect"><strong>Campus Connect</strong></a></td>
    <td>Networking platform with real-time messaging for 1K+ users</td>
    <td>React, TypeScript, Node.js, PostgreSQL, Socket.IO</td>
